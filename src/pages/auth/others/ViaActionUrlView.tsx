...
const ResendEmail: React.FC<ResendEmailProps> = ({ emailForSignIn, onResendEmail, onRecreateAccount }) => {
  return (
    <div className='flex flex-col'>
        ...
        <div className='flex flex-col mt-10'>
            <Button children='メールを再送信' variant="contained" onClick={onResendEmail} />
        </div>
...
const AuthFailure: React.FC<AuthFailureProps> = ({
  ...
  return (
    <div className='flex flex-col text-xl my-16'>
      認証に失敗しました。
      {emailForSignIn ? (
        <ResendEmail emailForSignIn={emailForSignIn} onResendEmail={onResendEmail} onRecreateAccount={onRecreateAccount}/>
      ) : (
