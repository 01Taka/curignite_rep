...
const SpaceStartActionsView: FC<SpaceStartActionsViewProps> = ({ isStarting, toSetting, onStart }) => {
  return (
    <>
      <div className='flex flex-col relative items-center w-full'>
        ...
        <CircularButton size="x4l" mobileSize='xl' bgColor="main" className='mt-2' invalidation={isStarting} onClick={onStart}>
          {isStarting ? (
            <CircularProgress />
          ) : (
            <>スペースを<br />開始する</>
