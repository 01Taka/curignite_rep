...
const TeamContainer: FC<TeamContainerProps> = ({ teamName, iconUrl, myTeam, currentDisplay, memberNumber, maxDisplayLearningNumber = 3 }) => {  
  return (
    <div className={cn(
    ...
    >
      <CardHeader
        ...
        //subheader={<SubheaderContent maxDisplayNumber={maxDisplayLearningNumber}/>}
      />
    </div>
  );
};
